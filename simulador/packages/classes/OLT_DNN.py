...
def get_resource_path(relative_path):
    if hasattr(sys, '_MEIPASS'):
        ...
        return os.path.join(os.path.dirname(os.path.abspath(__file__)), relative_path.replace("./simulador/packages/classes/", ""))



# Cargar el modelo entrenado
model_path = get_resource_path("./simulador/packages/classes/mejor_modelo_dnn_v2.pkl")
model = joblib.load(model_path)

# Definir el MinMaxScaler y cargarlo desde el archivo
scaler_path = get_resource_path("./simulador/packages/classes/scaler_v2.pkl")
