...
from packages.classes.InterfazAgente import AgentInterface
...
class OLT:
    ...
    def __init__(self, env, splitter_in, splitter_out):
        ...
        self.interface = AgentInterface(N_ONTS, R_tx, T_CICLO, self.B_guaranteed, self.B_Disp, self.B_max, L_BUFFER_ONTS)
